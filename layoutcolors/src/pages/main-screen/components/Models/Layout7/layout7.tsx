...
const Layout7 = () => {
  return (
    <div className="layout" id="layout7">
      <div className="header_layout7">
        <div className="logo_layout7"></div>
        <h2>Opcão</h2>
        <h2>Opcão</h2>
        <h2>Opcão</h2>
        <div className="boxes_layout7">
          <div className="box1_layout7">Entre</div>
          <div className="box2_layout7">Cadastre-se</div>
        </div>
      </div>
